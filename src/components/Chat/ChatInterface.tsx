...
import { Send, Paperclip, Bot, ThumbsUp, ThumbsDown } from "lucide-react";
      ...
      <Card className="flex flex-col h-full">
        <CardHeader className="pb-3">
          <div className="flex justify-between items-center">
            ...
            <Badge variant="outline" className="bg-support-100 text-support-800">
              AI-Powered
            </Badge>
          </div>
        </CardHeader>
                  ...
                  {!msg.isUser && (
                    <div className="flex gap-2 items-center mb-1">
                      ...
                      <span className="text-xs font-medium">
                        {msg.isAi ? "AI Assistant" : "Agent Sarah"}
                      </span>
                    </div>
                  )}
